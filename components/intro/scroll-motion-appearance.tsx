...
const ScrollMotionAppearance = ({
  ...
  return (
    <IntroSection ref={appearanceRef}>
      ...
      >
        <div className="absolute left-1/2 top-1/2 aspect-[4/5] w-[180px] -translate-x-1/2 -translate-y-1/2 md:w-60">
          <div className="absolute -left-[32px] top-0 size-full rounded-[50%] border-[20px] border-bgc-dark transform-style-3d before:absolute before:size-full before:rounded-[50%] before:outline before:outline-[75px] before:outline-offset-[20px] before:outline-white before:content-[''] after:absolute after:bottom-[-20px] after:right-0 after:h-[100px] after:w-[220px] after:bg-white after:content-[''] after:translate-x-1/2 after:translate-y-full md:-left-[50px] md:-top-[6%] md:border-[30px] md:-translate-y-[3.4%] md:before:outline-offset-[30px] md:after:bottom-[-30px]">
